            ...
            <div class="header__inner">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <!-- Brand logo -->
                        <a href="index.htm" class="brand-img stretched-link">
                            <img src="{{asset('backend/img/logo.svg')}}" alt="Admin" class="Admin" width="40" height="40">
                        </a>
                                        ...
                                        <div class="d-grid gap-2 ps-5 pe-2">
                                            <div class="row g-1 rounded-3 overflow-hidden">
                                                <div class="col-6 mt-0">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-1.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6 mt-0">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-3.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-2.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-4.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-6.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('backend/img/megamenu/img-5.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                            </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-300px">
                                ...
                                <div class="list-group list-group-borderless">
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="img-xs rounded-circle" src="{{asset('backend/img/profile-photos/7.')}}')}}" alt="Profile Picture" loading="lazy">
                                        </div>
                                        <div class="flex-grow-1 ">
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="img-xs rounded-circle" src="{{asset('backend/img/profile-photos/3.')}}')}}" alt="Profile Picture" loading="lazy">
                                        </div>
                                        <div class="flex-grow-1 ">
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    <div class="flex-shrink-0">
                                        <img class="img-sm rounded-circle" src="{{asset('backend/img/profile-photos/1.png')}}" alt="Profile Picture" loading="lazy">
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="list-group list-group-borderless h-100 py-3">
                                            ...
                                            <form method="post" action ="{{route('logout')}}">
                                                @csrf
                                                <button class="list-group-item list-group-item-action"  title="logout" type="submit" value="Logout">
                                               <i class="demo-pli-unlock fs-5 me-2"></i> Logout</button>
                                            </form>
                                            <!-- <a href="#" class="list-group-item list-group-item-action">
