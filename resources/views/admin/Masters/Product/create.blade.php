        ...
        <div class="row">
          ...
          <div class="card product-view wow bounceInUp animated">
            <div class="card-body product-essential">
                <div class="red box">
                  <form class="row row-cols-md-auto g-3 align-items-center"  method="post" id="main_form" enctype='multipart/form-data' action="{{route('products.store')}}">
                    @csrf
                    <div class="row form-group">
                      <div class="col-md-2">
                        <label class="">Name</label><br>
                        <input type="text" placeholder="Product Name" required="true" class="form-control input-text required-entry" name="name">
                      </div>
<!--                       <div class="col-md-3">
                      ...
                      <div class="col-md-2">
                        ...
                        <input type="number" placeholder="Price" class="form-control input-text required-entry col-md-12" required="true" name="price">
                      </div>
                      <div class="col-md-2">
                        <label>Tax (%)</label><br>
                        ...
                        <select required="true"  name="tax"  class="form-select address-select col-md-12" title="" required="true">
                          ...
                          @if(!empty($taxes))
                            @foreach($taxes  as $key => $value)
                              <option value="{{ $value->tax_per }}">{{ $value->tax_per }}</option>
                            @endforeach
                          @endif
                        </select>
                      </div>       
                      <div class="col-md-2">
                          ...
                          <input type="number" class="form-control input-text" name="dispatch_days">
                      </div>
                      <div>
                          <label>Via Mail Charge</label>
                          <input type="number" class="form-control input-text" name="email_charge">
                      </div>
                      <div class="col-md-2">
                          <label>Minimum Purchase Quantity</label>
                          <input type="number" name="min_quantity" value="1" class="form-control input-text">
                      </div>
